...
## Instalação R, Rstudio e Rtools

::: callout-note
**R** é o nome da linguação de programação, **Rstudio** é apenas uma interface gráfica que agrega um conjunto de funcionalidades para facilitar o uso da linguagem de modo cojunto a outras ferramentas. **Rtools** instala um conjunto de compiladores (C/C++, Fortran) que podem ser importantes para instalar alguns tipos de pacotes. Essas funcionalidades já vem instaladas em computadores com sistemas operacioais MacOS ou Linux. Portanto, o Rtools é necessário apenas para computadores com Windows.
:::

### Como instalar o R?

::: callout-important
Para que possamos aproveitar ao máximo as aulas práticas, será muito importante evitarmos problemas decorrentes do uso de diferentes versões do R, Rstudio e Rtools. Assim, é importante que **todos** estejam utilizando as seguintes versões `R-4.5.2` do R, a `4.4` do RTools e a `2026.01.0-392` do Rstudio (ou superiores).
:::

Vá ao site <https://posit.co/download/rstudio-desktop/#download> e clique em instalar R conforme @fig-instalacao abaixo.

![Link para página do R](images/install_R.png){#fig-instalacao width=400}

Em seguida, clique na opção em vermelho na @fig-RCran caso sua máquina utilize Windows. Caso seu sistema operacional seja outro, clique na opção que se adeque ao seu caso. 

![Link para página do R base e Rtools](images/install_R_cran){#fig-RCran width=600}

Na sequência, você verá os links para instalar a linguagem R pela primeira vez em sua máquina e também o link para a instalação do Rtools (veja @fig-Rbase).

![Link para download do R base e Rtools](images/install_R_base){#fig-Rbase width=600}

Por fim, retorne ao site inicial e faça download e instale o Rstudio conforme mostrado abaixo.

![Link para download do Rstudio](images/install_Rstudio){#fig-Rstudio width=600}
